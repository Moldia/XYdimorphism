...
% load('Results\Histograms_atan_PCDH11\PCDH11_ratio.mat');
load('Results\Histograms_atan_PCDH11_2std\PCDH11_ratio.mat');
load('Nuclei_full\Boundaries_all_untransformed.mat');
...
%         print(gcf,'-dpng','-r500',['Results\Histograms_atan_PCDH11\' Sample{s} '_significant.png']);
        print(gcf,'-dpng','-r500',['Results\Histograms_atan_PCDH11_2std\' Sample{s} '_significant.png']);
